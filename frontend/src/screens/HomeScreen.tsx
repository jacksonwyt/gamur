...
import { Appbar, Avatar, Button, Card, List, Text, Title } from 'react-native-paper';
  ...
  return (
    <SafeAreaView style={styles.container} edges={['bottom', 'left', 'right']}>
      <Appbar.Header>
        ...
        <Appbar.Action icon="account-circle" onPress={handleNavigateToProfile} />
        ...
        <Card style={styles.card}>
          <Card.Content>
            ...
            <List.Item
              ...
              right={(props) => <List.Icon {...props} icon="checkbox-blank-circle-outline" />}
            />
